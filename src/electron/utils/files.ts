...
export function getDefaultDataFolderRoot() {
    ...
    const appFolderName = "AliancaShow"
...
// how: Place any file in your Documents/AliancaShow folder that has the FIXES key in it's name (e.g. OPEN_APPDATA_SETTINGS), when you now start your app the fix will be triggered!
const FIXES = {
