...
<button
    ...
    {disabled}
    style="
    background: {variant === 'contained' ? (gradient ? 'linear-gradient(160deg, #750b0b 0%, #9c1114 20%, #f21a27 60%, #f1d278 100%)' : 'var(--secondary)') : variant === 'outlined' ? 'var(--primary-darkest)' : 'transparent'};
