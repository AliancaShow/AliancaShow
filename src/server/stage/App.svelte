<script lang="ts">
    ...
    const freeshowLogo = new URL("../../../public/import-logos/aliancashow.webp", import.meta.url).href
...
{:else if $layouts === null}
    <div class="auth-page">
        <div class="panel" style="align-items: center; text-align: center;">
            <div class="brand">
                <img class="logo" src={freeshowLogo} alt="AliançaShow logo" draggable="false" />
                <h1>StageShow</h1>
            </div>
